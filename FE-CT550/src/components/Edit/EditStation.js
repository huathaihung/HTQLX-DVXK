			...
			<Row gutter={16}>
				<Col span={12}>
					<Form.Item label="Tên Trạm">
						<Input placeholder="Vui lòng nhập tên trạm" name="name" onChange={handleChange("name")} value={formik.values.name} />
					</Form.Item>
				</Col>
				<Col span={12}>
			...
			<Row gutter={16}>
				<Col span={12}>
					<Form.Item label="Tỉnh / Thành Phố">
						<Select placeholder="Vui lòng chọn tỉnh / thành phố" value={formik.values.province} name="province" onChange={handleChangeSelect("province")} options={renderProvince()}></Select>
					</Form.Item>
				</Col>
			</Row>
