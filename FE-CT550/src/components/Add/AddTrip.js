				...
				<Col span={12}>
					<Form.Item
						...
						rules={[
							{
								required: true,
								message: "Bạn chưa chọn điểm đến",
							},
						]}
					>
						<Select options={renderStation()}></Select>
				...
				<Col span={12}>
					<Form.Item
						...
						rules={[
							{
								required: true,
								message: "Bạn chưa chọn giờ khởi hành",
							},
						]}
					>
						<TimePicker />
				...
				<Col span={12}>
					<Form.Item
						...
						rules={[
							{
								required: true,
								message: "Bạn chưa chọn giờ kết thúc chuyến",
							},
						]}
					>
						<TimePicker />
											...
											<Col span={12}>
												<Form.Item
													...
													rules={[
														{
															required: true,
															message: "Bạn chưa chọn điểm đón",
														},
													]}
												>
											...
											<Col span={12}>
												<Form.Item
													...
													rules={[
														{
															required: true,
															message: "Bạn chưa chọn điểm trả",
														},
													]}
												>
											...
											<Col span={12}>
												<Form.Item
													...
													rules={[
														{
															required: true,
															message: "Bạn chưa chọn giờ trả khách!",
														},
													]}
												>
		...
		<>
			<Content style={{margin: "0 16px"}}>
				<Breadcrumb style={{margin: "16px 0"}}>
					...
					<Breadcrumb.Item>Quản Lý Chuyến Xe</Breadcrumb.Item>
					<Breadcrumb.Item>Thêm Chuyến Đi</Breadcrumb.Item>
				</Breadcrumb>
