	...
	return (
		<Content style={{margin: "0 16px"}}>
			<Breadcrumb style={{margin: "16px 0"}}>
				...
				<Breadcrumb.Item>Chi Tiết Chuyến</Breadcrumb.Item>
			</Breadcrumb>

			<div className="site-layout-background" style={{padding: 24, minHeight: 360}}>
				<h1>
					Danh sách các chuyến đi từ {tripDetail.from?.province} - {tripDetail.from?.address} đến {tripDetail.to?.province} - {tripDetail.to?.address} ngày {moment(tripDetail?.startTime).format("DD-MM-YYYY")}
				</h1>
