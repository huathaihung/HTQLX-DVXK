...
export default function AdminTemplate(props) {
	...
	// if (userLogin.type !== "ADMIN" && userLogin.type !== "STAFF") {
	// 	alert("Bạn không có quyền truy cập vào trang này -.- !");
	// 	return <Redirect to="/" />;
	// }
	// return (
	...
	// 								<img src="/images/tt.png" alt={123} className="mb-5" />
	// 							</div>
	...
	// 							<Footer style={{textAlign: "center"}}>CT550 - Hứa Thái Hưng B1909922</Footer>
	// 						</Layout>
	// 					</Layout>
	// 				</Fragment>
	// 			);
					...
					<Fragment>
						<Layout style={{minHeight: "100vh"}}>
							<Sider collapsible collapsed={collapsed} onCollapse={changeCollapsed}>
								...
								<Menu theme="dark" defaultSelectedKeys={[{key}]} mode="inline">
									<SubMenu key="sub2" icon={<CarOutlined />} title="Quản Lý Về Xe">
										<Menu.Item
											key="1"
											onClick={() => {
												history.push("/admin/station");
									...
									<SubMenu key="sub3" icon={<IdcardOutlined />} title="Quản Lý Về Vé">
										<Menu.Item
											key="4"
											onClick={() => {
												history.push("/admin/trip");
