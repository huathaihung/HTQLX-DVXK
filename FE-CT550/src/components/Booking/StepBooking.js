			...
			{isLoadingSpin ? (
				...
				<>
					<div class="TrustMessage__Container-sc-8xur6b-0 deVKGv trust-message-container undefined" style={{color: "rgb(14, 99, 193)"}}>
						<p class="base__Body02-sc-1tvbuqk-14 VqdXU trust-message-content">HTH cam kết giữ đúng vị trí bạn đã chọn.</p>
					</div>
	...
	return (
		<div className="info-trip">
			<div className="TrustMessage__Container-sc-8xur6b-0 deVKGv trust-message-container undefined">
				<p className="base__Body02-sc-1tvbuqk-14 VqdXU trust-message-content">Chỉ còn 1 bước nữa! HTH cam kết chỉ sử dụng thông tin trong việc ghi nhận vé.</p>
			</div>
			...
			<div className="noteInfo">
				...
				<div className="info-note-content">
					...
					<p className="base__Body02-sc-1tvbuqk-14 VqdXU color--dark">Bằng việc nhấn nút Tiếp Tục, bạn đồng ý với <a>Chính sách bảo mật thông tin</a> và <a>Quy chế</a>.</p>
				</div>
			</div>
			<div class="footer">
				<div class="footer-left"></div>
