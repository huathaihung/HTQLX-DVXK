...
export default function EditSeat(props) {
	...
	return (
		<Form name="basic" initialValues={{remember: true}} requiredMark={false} autoComplete="off">
			<Form.Item label="Ghế" rules={[{required: true, message: "Vui lòng nhập vào tên của bạn"}]}>
				<Input name="name" onChange={handleChangeForm("name")} value={formik.values.name} />
			</Form.Item>
			<Form.Item label="Giá" rules={[{required: true, message: "Vui lòng nhập vào giá"}]}>
				<Input onChange={handleChangeForm("price")} value={formik.values.price} />
			</Form.Item>
			<Form.Item rules={[{required: true, message: "Vui lòng chọn loại"}]} label={"Loại Ghế"}>
			...
			<Form.Item rules={[{required: true, message: "Vui lòng chọn tầng"}]} label={"Trạng Thái"}>
			...
			<Form.Item rules={[{required: true, message: "Vui lòng chọn tầng"}]} label={"Tầng"}>
