			...
			<Row gutter={16}>
				<Col span={12}>
					<Form.Item label="Tên Nhà Xe">
						<Input placeholder="Vui lòng nhập tên nhà xe" name="name" onChange={handleChange("name")} value={formik.values.name} />
					</Form.Item>
				</Col>
				<Col span={12}>
			...
			<Row gutter={16}>
				<Col span={12}>
					<Form.Item label="Loại Xác Nhận">
						<Select placeholder="Vui lòng chọn loại xác nhận" value={formik.values.confirmType} name="confirmType" onChange={handleChangeSelect("confirmType")}>
			...
			<Row gutter={16}>
				<Col span={12}>
					<Form.Item label="Đánh Giá">
						<Input style={{width: "100%"}} type="number" placeholder="Vui lòng nhập đánh giá" disabled value={formik.values.rate} />
					</Form.Item>
				</Col>
				<Col span={12}>
					<Form.Item label="Giá">
						<Input style={{width: "100%"}} type="number" placeholder="Vui lòng nhập giá" value={formik.values.price} onChange={handleChange("price")} />
					</Form.Item>
				</Col>
			</Row>
			<Row gutter={16}>
				<Col span={24}>
					...
					>
						<Input.TextArea rows={4} name="description" placeholder="Vui lòng nhập thông tin mô tả" value={formik.values.description} onChange={handleChange("description")} />
					</Form.Item>
				</Col>
			</Row>
			<Form.Item>
