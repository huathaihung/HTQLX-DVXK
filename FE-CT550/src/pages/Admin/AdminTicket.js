...
import AddTicketIcon from "@mui/icons-material/ConfirmationNumber";
import AddTicket from "../../components/Add/AddTicket";
...
export default function AdminTicket(props) {
	...
	console.log("file: AdminVehicle.js ~ line 39 ~ AdminVehicle ~ listVehicle", listVehicle);
	useEffect(() => {
	...
	const columns = [
		...
		},
		{
			...
			onFilter: (value, record) => record.tripPassengerId == value,
			filterSearch: true,
		},
		// {
		// 	title: "Nhà Xe",
	...
	return (
		<Content style={{margin: "0 16px"}}>
			<Breadcrumb style={{margin: "16px 0"}}>
				...
				<Breadcrumb.Item>Quản Lý Vé</Breadcrumb.Item>
			</Breadcrumb>
