							...
							<>
								{fields.map(({key, name, ...restField}) => (
									<Space key={key} style={{display: "flex", marginBottom: 8}} align="baseline">
										<Form.Item {...restField} name={[name, "name"]} rules={[{required: true, message: "Nhập tên ghế"}]}>
										...
										<Form.Item {...restField} name={[name, "floor"]} rules={[{required: true, message: "Chọn tầng"}]}>
										...
										<Form.Item {...restField} name={[name, "type"]} rules={[{required: true, message: "Chọn loại ghế"}]}>
