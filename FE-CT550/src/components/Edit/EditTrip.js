...
export default function EditTrip(props) {
	...
	return (
		<Form layout="vertical" name="basic" autoComplete="off">
			<Row gutter={16}>
				<Col span={12}>
					<Form.Item label="Nhà Xe">
						<Input placeholder="Vui lòng nhập tên nhà xe" value={formik.values.passengerName} name="passengerName" onChange={(e) => formik.setFieldValue("passengerName", e.target.value)} disabled />
					</Form.Item>
				</Col>
				<Col span={12}>
					<Form.Item label="Xe">
						<Input style={{width: "100%"}} name="vehicleName" placeholder="Vui lòng nhập tên xe" disabled value={formik.values.vehicleName} onChange={(e) => formik.setFieldValue("vehicleName", e.target.value)} />
					</Form.Item>
				</Col>
			</Row>
			<Row gutter={16}>
				<Col span={12}>
					<Form.Item label="Trạng Thái">
						<Select placeholder="Vui lòng chọn trạng thái" value={formik.values.status} onChange={changeOption}>
							<Option value="depart">
			...
			<Row gutter={16}>
				<Col span={12}>
					<Form.Item label="Số Vé" rules={[{required: true, message: "Vui lòng chọn người phê duyệt"}]}>
						<Input style={{width: "100%"}} type="number" placeholder="Vui lòng nhập số vé" disabled value={formik.values.soVe} />
					</Form.Item>
				</Col>
				<Col span={12}>
			...
			<Row gutter={16}>
				<Col span={24}>
					...
					>
						<Input.TextArea rows={4} name="description" placeholder="Vui lòng nhập thông tin mô tả" value={formik.values.description} />
					</Form.Item>
				</Col>
			</Row>
			<Form.Item>
