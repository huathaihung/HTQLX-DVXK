			...
			<Row gutter={16}>
				<Col span={12}>
					<Form.Item label="Tên Xe">
						<Input placeholder="Vui lòng nhập tên xe" name="name" onChange={handleChange("name")} value={formik.values.name} />
					</Form.Item>
				</Col>
				<Col span={12}>
			...
			<Row gutter={16}>
				<Col span={12}>
					<Form.Item label="Loại Xe">
						<Select placeholder="Vui lòng chọn loại xe" value={formik.values.type} name="confirmType" onChange={handleChangeSelect("type")}>
			...
			<Row gutter={16}>
				<Col span={12}>
					<Form.Item label="Số Ghế">
						<Input style={{width: "100%"}} type="number" placeholder="Vui lòng nhập số ghế" disabled value={formik.values.numberSeat} />
					</Form.Item>
				</Col>
				<Col span={12}>
					<Form.Item label="Số Tầng">
						<Input style={{width: "100%"}} type="number" placeholder="Vui lòng nhập số tầng" value={formik.values.numberFloors} onChange={handleChange("numberFloors")} />
					</Form.Item>
				</Col>
			</Row>
			<Row gutter={16}>
