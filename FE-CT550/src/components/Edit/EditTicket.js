		...
		<Form layout="vertical" name="basic" autoComplete="off">
			...
			<Row gutter={16}>
				...
				<Col span={12}>
					<Form.Item label="Điểm Trả">
						<Select
							placeholder="Vui lòng chọn điểm trả"
			...
			<Row gutter={16}>
				<Col span={24}>
					...
					>
						<Input.TextArea rows={4} name="note" placeholder="Vui lòng nhập ghi chú" value={formik.values.note} onChange={handleChange("note")} />
					</Form.Item>
				</Col>
			</Row>
			<Form.Item>
