				...
				<Col span={12}>
					<Form.Item
						...
						rules={[
							{
								required: true,
								message: "Bạn chưa nhập tên trạm",
							},
						]}
						name="name"
					>
						<Input placeholder="Vui lòng nhập tên trạm" />
					</Form.Item>
				</Col>
				<Col span={12}>
					<Form.Item
						...
						name="address"
					>
						<Input placeholder="Vui lòng nhập địa chỉ" style={{width: "100%"}} />
					</Form.Item>
				</Col>
			</Row>
			<Row gutter={16}>
				<Col span={12}>
					<Form.Item
						...
						name="province"
					>
						<Select placeholder="Vui lòng chọn tỉnh / thành phố" name="province" options={renderProvince()}></Select>
					</Form.Item>
				</Col>
			</Row>
